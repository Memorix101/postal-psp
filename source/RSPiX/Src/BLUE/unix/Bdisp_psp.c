...
// draw
//drawTexture(&myTexture, SCREEN_WIDTH / 2 - 240, SCREEN_HEIGHT / 2 - 136, 480, 272);
//drawTexture(&myTexture, SCREEN_WIDTH / 2 - myTexture.width / 2, SCREEN_HEIGHT / 2 - myTexture.height / 2, myTexture.width, myTexture.height);
drawTexture(&myTexture, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
